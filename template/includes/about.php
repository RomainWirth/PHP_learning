...
<div class="blue flex-column justify-between align-center w100">
    ...
    <div class="flex-column justify-between align-center">
        <p class="text">
            ...
            Sed pretium condimentum elit porttitor posuere. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Ut et tristique diam.<br>
            Vivamus auctor, orci id imperdiet gravida, mi nisi pellentesque nibh, sed auctor arcu orci ac nisi. Curabitur consectetur venenatis semper.<br>
            Aenean ut malesuada lacus. Praesent quis consectetur urna, non posuere justo. Pellentesque in tortor urna.
        </p>
        <div>
            <img src="https://cdn.pixabay.com/photo/2023/03/31/06/45/camera-7889301_960_720.jpg" alt="le_photographe">
        </div>
    </div>
</div>